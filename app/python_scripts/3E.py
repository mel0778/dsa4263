...
plt.savefig(nn_confusion_matrix_path)
plt.show()
...
plt.grid(True)
plt.savefig(nn_train_confidence_score_path)
plt.show()
...
plt.grid(True)
plt.savefig(nn_test_confidence_score_path)
plt.show()
