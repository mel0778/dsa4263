...
plt.title('SVM Confusion Matrix (Without SMOTE)')
plt_path = os.path.join(figures_dir, "svm_confusion_matrix.png")
...
# %%
# Plot histogram
plt_path = os.path.join(figures_dir, "svm_train_confidence_score.png")
plt.hist(train_confi, bins=30, edgecolor='black')
plt.xlabel('Train Risk Scores')
plt.ylabel('Frequency')
plt.title('SVM Histogram of Train Data Confidence Scores (Without SMOTE)')
plt.grid(True)
plt.savefig(plt_path)
plt.show()

# %%
plt_path = os.path.join(figures_dir, "svm_test_confidence_score.png")
# Plot histogram
plt.hist(test_confi, bins=30, edgecolor='black')
plt.xlabel('Test Risk Scores')
plt.ylabel('Frequency')
plt.title('SVM Histogram of Test Confidence Scores (Without SMOTE)')
plt.grid(True)
plt.savefig(plt_path)
plt.show()
